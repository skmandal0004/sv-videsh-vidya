...
const ApplyingComponents = () => {
  return (
    <div className="bg-gray-100 py-10 px-2 lg:px-12 text-center">
      {/* Heading */}
      <h2 className="text-3xl lg:text-4xl font-normal text-gray-900 tracking-wide">
  Applying for Visa and Selecting Visa Interview <br /> date
</h2>
      {/* Description */}
      <p className="mt-6 text-gray-700 text-xl leading-loose max-w-3xl mx-auto font-light">
      ...
      {/* Process List */}
      <ul className="mt-6 text-lg text-gray-800 space-y-1 font-light">
