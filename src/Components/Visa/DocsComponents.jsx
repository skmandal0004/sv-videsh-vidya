...
const DocsComponents = () => {
  return (
    <div className="bg-white py-6 px-5 lg:px-20">
      {/* Heading */}
      <h2 className="text-3xl font-bold text-center text-black mb-4">
        Collecting Documents Required <br/>for Visa
      </h2>

      <p className="text-center text-gray-500 leading-loose max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 text-gray-600">
