...
const CountryComponents = () => {
  return (
    <div
      className="relative flex items-center justify-center w-full h-screen bg-gray-900 px-4 py-10"
      style={{
    ...
    >
      ...
      {/* Main Content */}
      <div className="relative flex flex-col items-center justify-center text-center text-white w-full max-w-5xl px-6">
        {/* Title Section */}
        <h1 className="text-5xl font-extrabold leading-tight drop-shadow-lg mb-4">
          SVV Abroad <br /> University Admission List
        </h1>
        <h2 className="text-3xl font-semibold drop-shadow-lg mb-8">
          🌍 Countries Available
        </h2>

        {/* Countries List Section */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full max-w-4xl bg-white bg-opacity-20 backdrop-blur-lg p-6 rounded-lg shadow-lg border border-gray-300 border-opacity-40">
          {[
            "🇺🇸 USA",
            "🇨🇳 China",
            "🇨🇦 Canada",
