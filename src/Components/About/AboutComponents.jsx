    ...
    <div className="bg-indigo-500 text-gray-900 py-16 px-6 md:px-20">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg leading-relaxed text-gray-50">
          <strong className="text-indigo-950 font-bold">S V Videsh Vidya Enterprises</strong> iss dedicated to helping students from all over India to realize their dream of 
