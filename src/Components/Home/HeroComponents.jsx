...
export function HeroComponents() {
  return (
    <div className="relative w-screen h-screen">
      ...
      >
        {/* Slide 1 - With Centered Text & Button */}
        <div className="relative w-screen h-screen">
          <img
  ...
  <h2 className="text-4xl font-bold bg-black/50 px-7 py-1 rounded-md">Study <br/>Abroad Now!</h2>
</div>
          {/* Centered Content */}
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center -mt-6">
  ...
  <h2 className="absolute top-10 left-10 ml-10 mt-5 text-4xl md:text-6xl font-bold text-white">
  Study Abroad Now
</h2>
  ...
  <p className="text-xl md:text-2xl max-w-lg mx-auto -mt-28">
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center space-y-6">
    ...
    {/* Move Heading & Subheading to the Top */}
    <div className="absolute top-10 left-1/2 transform -translate-x-1/2 w-full px-6">
      <h3 className="text-2xl md:text-5xl font-semibold mb-4 mt-5">
        Pursue your goals with our expert faculties
      </h3>
      <p className="text-lg md:text-5xl mt-2">
        Get online live coaching:
      </p>
    </div>
